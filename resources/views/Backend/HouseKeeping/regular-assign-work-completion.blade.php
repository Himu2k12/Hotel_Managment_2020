    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-12">
            <div class="card mb-4 py-3 border-bottom-info">
                <div class="card-body">
                    <h4 style="text-align: center">Regular Service Completion </h4>
                    <h6 style="text-align: center" class="text-success">{{ Session::get('message') }}</h6>
                </div>
            </div>
        </div>
        <form method="post" action="{{route('complete-regular-service')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="Partial_payment" class="col-md-4 col-form-label text-md-right">{{ __('Comments') }}</label>
                                <div class="col-md-8">
