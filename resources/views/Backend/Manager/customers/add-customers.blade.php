        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('create-customer') }}" name="confirmBooking">
                            @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-5 col-form-label text-md-right">{{ __('Full Name') }}<span style="color: red">*</span></label>
                                <div class="col-md-7">
                                    <input id="name" type="text" class="form-control" name="full_name" value="{{ old('full_name') }}" required autocomplete="name" autofocus>
                                    @error('full_name')
...
{{--                                    <span  id="mobile_no_error" style="color: red;">{{ $errors->has('mobile_no') ? $errors->first('mobile_no') : ' ' }}</span>--}}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="national_id" type="text" class="form-control" name="national_id" value="{{old('national_id')}}" autocomplete="National ID">
                                    @error('national_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="passport_no" type="text" class="form-control" value="{{old('passport_no')}}" name="passport_no" >
                                    @error('passport_no')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="mobile_two" type="text" class="form-control @error('mobile_two') is-invalid @enderror" value="{{old('mobile_two')}}" name="mobile_two">
