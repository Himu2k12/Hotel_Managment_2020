...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('update-customer') }}" name="UpdateCustomer">
                            @csrf
                            <div class="form-group row">
                                <label for="name" class="col-md-5 col-form-label text-md-right">{{ __('Full Name') }}<span style="color: red">*</span></label>
                                <div class="col-md-7">
                                    <input id="name" type="text" class="form-control @error('full_name') is-invalid @enderror" name="full_name" value="{{ $customers->full_name }}" required autocomplete="name" autofocus>
                                    @error('full_name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="mobile_no" onfocusout="viewCustomerInfo()" minlength="11" maxlength="11" type="text" class="form-control @error('mobile_no') is-invalid @enderror" name="mobile_no" value="{{$customers->mobile_no}}" required autocomplete="Mobile Number">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="national_id" type="text" class="form-control" value="{{$customers->national_id}}" name="national_id" autocomplete="National ID">
                                    @error('national_id')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="passport_no" type="text" class="form-control" value="{{$customers->passport_no}}" name="passport_no" >
                                    @error('passport_no')
                                    <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <input id="mobile_two" type="text" class="form-control @error('mobile_two') is-invalid @enderror" value="{{$customers->mobile_two}}" name="mobile_two">
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="occupation" type="text" class="form-control @error('occupation') is-invalid @enderror" name="occupation" value="{{ $customers->occupation}}" required autocomplete="Last Name">
                                @error('occupation')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="Pov" type="text" class="form-control @error('purpose_of_visit') is-invalid @enderror" name="purpose_of_visit" value="{{ $customers->purpose_of_visit }}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" required>{{$customers->address}}</textarea>
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input id="city" type="text" class="form-control @error('city') is-invalid @enderror" value="{{$customers->city}}" name="city" required autocomplete="City">
                                @error('city')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="form-group row"  style="padding-bottom: 30px">
                            ...
                            <div class="col-md-7">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $customers->email }}" autocomplete="email">
        ...
        <script>
            ...
            document.forms['UpdateCustomer'].elements['country'].value = '{{ $customers->country }}';
        </script>
