    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div style="width: 450px; float: left" >
                <h2 style="padding-left: 150px; color:#354356"><strong>Hotel New York</strong></h2>
            </div>
            <div style="float: right">
                <b> Generated By:</b> {{Auth::User()->name}}<br><br>
                <b>Date:</b> {{date('d-m-Y')}}
            </div>
            <div style="clear: both"></div>
            <div class="invoice-title col-sm-2" style="float: left">
                <h2 style="color: #0b2e13">Salary Sheet</h2>
            </div>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 style="text-align: center"><strong>Staff Salary Sheet</strong></h3>
                </div>
                <div style="text-align: center; margin-left: auto; margin-right: auto">
                    <div class="table-responsive" >
                        <table align="center" class="table table-borderless table-hover table-striped table-light">
                            ...
                            <tr>
                                <th style="width: 2%">Salary ID</th>
                                <th>Staff Name</th>
                                <th>Salary_Date</th>
                                <th>Over Time(Hour)</th>
                                <th>Per Hour Cost(TK)</th>
                                <th>Total Over Time(TK)</th>
